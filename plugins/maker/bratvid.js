...
contoh penggunaan:
> \`.bratvid halo semuanya\`
> \`.bratvid\` (sambil me-reply pesan orang lain)`,
  ...
  async execute(m, { sock, args }) {
    ...
    try {
      ...
      const apiUrl = `https://api.nexray.eu.cc/maker/bratvid?text=${encodeURIComponent(text)}`
