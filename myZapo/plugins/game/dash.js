...
// Menggunakan objek 'sock' dari Zapo-JS
...
export default {
    command: 'dash',
    alias: ['sonic', 'speedy', 'speeddash'],
    category: 'game',
    description: 'Main game HTML interaktif Speedy Dash (Boss & Laser Edition)',

    async execute(m, { sock }) {
        try {
            await kirimForwardSigned(sock, m.chat, DASH_HTML, '🌀 SPEEDY DASH v4')
        } catch (e) {
            console.error('[DASH ERROR]', e?.message || e)
